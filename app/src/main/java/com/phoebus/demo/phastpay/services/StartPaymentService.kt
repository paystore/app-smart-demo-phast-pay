...
class StartPaymentService @Inject constructor(
    ...
    operator fun invoke(
        ...
        val callback = object : PhastPayClient.ICallbackService {
            ...
            override fun onSuccess(response: String?) {
                ...
                result.onSuccess { res ->
                    LastTransactionState.updateAppClientId(res.appClientId ?: "")
                    LastTransactionState.updatePaymentId(res.paymentId ?: "")
        ...
        try {
            val request = json.encodeToString(phastPayStartPaymentRequest)
