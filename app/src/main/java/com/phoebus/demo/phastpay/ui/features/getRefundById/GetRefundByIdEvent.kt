...
sealed interface GetRefundByIdEvent {
    data object OnSubmit : GetRefundByIdEvent
    ...
    data class UpdatePreviewMerchantReceipt(val preview : Boolean ) : GetRefundByIdEvent
    data class UpdatePreviewCustomerReceipt(val preview : Boolean ) : GetRefundByIdEvent
