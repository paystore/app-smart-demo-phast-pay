...
class GetPaymentsToRefundService @Inject constructor(
    ...
    operator fun invoke(
        ...
        val callback = object : PhastPayClient.ICallbackService {
            ...
            override fun onSuccess(response: String?) {
                ...
                val result = runCatching {
                    json.decodeFromString<PhastPayGetPaymentsToRefundResponse>(response)
                }
        ...
        try {
            val requestJson = json.encodeToString(phastPayGetPaymentsToRefundRequest)
