...
class GetPaymentByIdService @Inject constructor(
    ...
    operator fun invoke(
        ...
        val callback = object : PhastPayClient.ICallbackService {
            ...
            override fun onSuccess(response: String?) {
                ...
                val result = runCatching {
                    json.decodeFromString<PhastPayGetPaymentByIdResponse>(response)
                }
        ...
        try {
            val request = json.encodeToString(phastPayGetPaymentByIdRequest)
