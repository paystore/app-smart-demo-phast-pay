...
class GetTransactionsService @Inject constructor(
    ...
    operator fun invoke(
        ...
        val callback = object : PhastPayClient.ICallbackService {
            ...
            override fun onSuccess(response: String?) {
                ...
                val result = runCatching {
                    json.decodeFromString<PhastPayGetTransactionsResponse>(response)
                }
        ...
        try {
            val request = json.encodeToString(phastPayGetTransactionsRequest)
